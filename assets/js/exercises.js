...
const THEME_EXTRAS = {
  "donnees-base": {
    ...
    exercices: [
      { niveau: "facile", enonce: "Convertis à la main le binaire 1011 en décimal, puis vérifie avec Python.",
        code: `print(0b1011)        # vérification\nprint(int("1011", 2))`,
        solution: "1011 = 8 + 0 + 2 + 1 = 11." },
      { niveau: "moyen", enonce: "Écris une fonction nb_bits(v) qui renvoie le nombre de bits nécessaires pour coder v valeurs différentes.",
        code: `def nb_bits(v):\n    n = 0\n    while 2**n < v:\n        n += 1\n    return n\n\nprint(nb_bits(256), nb_bits(1000))`,
        solution: "256 → 8 bits ; 1000 → 10 bits (2¹⁰ = 1024 ≥ 1000)." },
      { niveau: "défi", enonce: "Écris une fonction qui code un entier de 0 à 255 sur 8 bits, et fais déborder une addition à 256.",
        code: `def add8(a, b):\n    return (a + b) % 256\n\nprint(add8(255, 1))   # déborde -> 0`,
        solution: "255 + 1 déborde sur 8 bits non signés et revient à 0 (overflow)." },
    ],
