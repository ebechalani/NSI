...
const GLOSSARY = [
  ...
  { terme: "Fonction d'ordre supérieur", theme: "term-langages", def: "Fonction qui prend une fonction en paramètre ou en renvoie une (map, filter, reduce, sorted avec key) : en fonctionnel, une fonction est une valeur comme une autre." },
  { terme: "lambda (fonction anonyme)", theme: "term-langages", def: "Fonction sans nom écrite en une expression, lambda x: x * 2 ; le mot vient du λ-calcul de Church, à la base des langages fonctionnels." },
  { terme: "map / filter / reduce", theme: "term-langages", def: "Les trois opérations du style fonctionnel : appliquer une fonction à chaque élément (mapping), ne garder que ceux qui vérifient un critère (filtrage), combiner tous les éléments en une valeur (pliage ou réduction)." },
  { terme: "Immutabilité", theme: "term-langages", def: "Principe fonctionnel : on ne modifie jamais une donnée, on en crée une nouvelle (sorted crée une liste, sort modifie la liste). Rend le code plus sûr, sans effet de bord." },
  { terme: "Effet de bord", theme: "term-langages", def: "Modification d'un état extérieur à la fonction (variable globale, liste ou objet passé en paramètre, affichage, fichier). Le style fonctionnel les évite ou les isole ; l'impératif en vit." },
  { terme: "Encapsulation / accesseur", theme: "term-langages", def: "Cacher les attributs d'un objet derrière des méthodes (get_x en lecture, set_y en écriture avec vérification) pour garantir un état valide ; en Python, c'est une convention (préfixe __)." },
  { terme: "Référence (objet)", theme: "term-langages", def: "Une variable ne contient pas l'objet mais son adresse : b = a fait désigner le même objet par deux noms ; modifier via b modifie ce que voit a." },
  { terme: "Programmation événementielle", theme: "term-langages", def: "Paradigme où des actions (des fonctions) sont déclenchées par des événements (clic, seuil dépassé) : interfaces graphiques, Scratch, automates de régulation. Hors programme, mais utile pour choisir un paradigme." },
