...
def taux_erreur(k):
    """Proportion (entre 0 et 1) des joueurs de test dont le poste est MAL prédit
    avec k voisins (comme dans l'exercice 18 du cours)."""
    # À toi de jouer
    ...


def meilleur_k(candidats):
    """Renvoie le k de la liste candidats qui donne le plus petit taux d'erreur
