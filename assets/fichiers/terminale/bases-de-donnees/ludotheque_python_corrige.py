"""
ludotheque_python_corrige.py — CORRIGÉ PROF de ludotheque_python.py (ne pas distribuer)
------------------------------------------------------------------------
...
Version complète, vérifiée par exécution : tous les assert passent.
"""
